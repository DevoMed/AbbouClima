...
namespace AbbouClima.Data
{
    ...
    {
        public static string GenerarHtml(Presupuesto presupuesto)
        {
...
<div class=""invoice-box"">
    <table cellpadding=""0"" cellspacing=""0"" >
        <tr class=""top"">
            ...
            <td colspan=""3"">
                <span>Presupuesto Nº:</span>{presupuesto.NºPresupuesto}
    ...
    <hr>     
    <div class=""footer"">
        Este presupuesto es válido por {presupuesto.Validez} días. Gracias por confiar en nosotros.
    </div>
</div>
